...
/**
 * A class that hold some variables that be used under integration test.
 */
public class VariablesUsedDuringThisTest {
    ...
    public final static  String SORTED_SWEDISH_TEST = "björnbär blev blivit brunsås bäckasiner dag del denna dimma dimma\n" +
            "dock dunge dunge där där enligt fram för för för\n" +
            "gamla genom hans hans hans har hav hwila hwila i\n" +
            "ingalunda inom ipsum kan kan kan kanske kom lax Löksås\n" +
            "mjuka nu nu nya Och och olika olika oss oss\n" +
            "på regn rännil räv samma samtidigt se se sitt sitt\n" +
            "själv själv sorgliga stig sällan sällan tre trevnadens trevnadens träutensilierna\n" +
            "Träutensilierna vad vemod vid år äng";

    public final  static String COMBINATION_TEST = SWEDISH_TEST +" "+ NUMBERS_TEST;
    ...
    public final static String SORTED_COMBINATION_TEST = "-98 -96 -96 -95 -95 -94 -93 -92 -92 -91\n" +
            ...
            "74 75 76 77 78 79 80 81 82 83\n" +
            "84 85 86 87 88 89 90 91 92 93\n" +
            "94 95 96 97 98 99 100 björnbär blev blivit\n" +
            "brunsås bäckasiner dag del denna dimma dimma dock dunge dunge\n" +
            "där där enligt fram för för för gamla genom hans\n" +
            "hans hans har hav hwila hwila i ingalunda inom ipsum\n" +
            "kan kan kan kanske kom lax Löksås mjuka nu nu\n" +
            "nya och Och olika olika oss oss på regn rännil\n" +
            "räv samma samtidigt se se sitt sitt själv själv sorgliga\n" +
            "stig sällan sällan tre trevnadens trevnadens träutensilierna Träutensilierna vad vemod\n" +
            "vid år äng";
}
